...
#include "scorbot_driver_effort/ScorbotJointParametersConfig.h"
#include "scorbot_driver_effort/ethercat_driver.h"
...
private:
  ...
  typedef dynamic_reconfigure::Server<
      scorbot_driver_effort::ScorbotJointParametersConfig>
